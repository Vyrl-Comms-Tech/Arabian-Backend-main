...
router.get("/save-offplan-property", NewOffPlanProperties.fetchAndSaveProperties);
router.get("/get-offplan-property", NewOffPlanProperties.getNewOffPlanProperties);
router.get("/get-offplan-single-property", NewOffPlanProperties.getSIngleOffplanProperty);
...
router.get(
  "/SequenceAgent",
  AgentController.getAgentsBySequence
);
