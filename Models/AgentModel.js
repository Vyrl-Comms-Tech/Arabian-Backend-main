...
// Agent Leaderboard Updates Original Agent linking correct model
// const mongoose = require("mongoose");
// const { v4: uuidv4 } = require("uuid");
...
// Agent Model - UPDATED with lastDealDays field but agents not linking
...
//     // ——— UPDATED: Leaderboard Performance Metrics ———
//     leaderboard: {
//       propertiesSold: {
//         type: Number,
//         default: 0,
...
//         default: null,
//       },
//       // ✅ NEW: Active properties added this month
//       activePropertiesThisMonth: {
//         type: Number,
//         default: 0,
//         min: [0, "Active properties cannot be negative"],
//       },
//       lastUpdated: {
//         type: Date,
//         default: Date.now,
...
// agentSchema.index({ specialistAreas: 1 });
// agentSchema.index({ "blogs.blogId": 1 });
// agentSchema.index({ sequenceNumber: 1 });
// agentSchema.index({ "leaderboard.propertiesSold": -1 });
// agentSchema.index({ "leaderboard.totalCommission": -1 });
// agentSchema.index({ "leaderboard.lastDealDays": 1 });
// agentSchema.index({ "leaderboard.activePropertiesThisMonth": -1 }); // ✅ NEW INDEX

// // ✅ NEW METHOD: Calculate active properties for current month
...
// // ✅ NEW METHOD: Calculate properties for specific month
// agentSchema.methods.calculateActivePropertiesForMonth = function (year, month) {
//   if (!this.properties || this.properties.length === 0) {
//     return 0;
//   }

//   const propertiesInMonth = this.properties.filter((property) => {
//     // Check if property is active
//     if (property.status !== "Live") {
//       return false;
//     }

//     // Check if property was added in specified month
//     const addedDate = new Date(property.addedDate);
//     return (
//       addedDate.getFullYear() === year &&
//       addedDate.getMonth() === month // 0-indexed
//     );
//   });

//   return propertiesInMonth.length;
// };

// // ✅ STATIC METHOD: Update all agents' activePropertiesThisMonth
...
//   if (metrics.lastDealDays !== undefined) {
//     this.leaderboard.lastDealDays = metrics.lastDealDays;
//   }

//   if (metrics.lastDealDate !== undefined) {
//     this.leaderboard.lastDealDate = metrics.lastDealDate;
//   }

//   // ✅ NEW: Update activePropertiesThisMonth
//   if (metrics.activePropertiesThisMonth !== undefined) {
//     this.leaderboard.activePropertiesThisMonth = metrics.activePropertiesThisMonth;
//   }
...
//   // ✅ AUTO-CALCULATE: Update activePropertiesThisMonth when properties change
//   if (this.isModified("properties")) {
//     this.leaderboard.activePropertiesThisMonth = this.calculateActivePropertiesThisMonth();
//   }
